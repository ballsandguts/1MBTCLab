 ...
 *
 * IMPORTANT: contact is exclusively through WhatsApp and Telegram.
 * Placeholder values are used here on purpose — do NOT hardcode these
 * URLs anywhere else in the codebase; always import SITE_CONFIG.
 */
